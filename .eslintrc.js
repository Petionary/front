module.exports = {
	...
	rules: {
		...
		'react-hooks/exhaustive-deps': [
			...
			{
				additionalHooks:
					'(useRecoilCallback|useRecoilTransaction_UNSTABLE)', // Recoil Hooks를 사용하는 경우 추가적인 의존성 검사
			},
		],
		...
		// 중첩된 삼항 연산자 허용
		'no-nested-ternary': 0,
		indent: ['error', 'tab'], // 탭 사용 규칙으로 설정
		'prettier/prettier': ['error', {useTabs: true}], // Prettier와 일치시키기
	},
};
